...
fesfiles =['transitions_wall.dat'] #,'fpt-B25_1.25.dat']
...
plt.xscale('log')
plt.ylim(0,1.005)
plt.title(r'$\tau$ = %0.2f $\mu$s; p = %0.3f'%(float(tau*mu*1E+6),float(pvalue)),fontsize=18)
plt.tight_layout()
#plt.savefig('KS-test_wall.png', bbox_inches='tight', dpi=300,transparent=True)
plt.show()
